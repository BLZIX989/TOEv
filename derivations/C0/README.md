...
No individual derivation folders (DER-ID/) have been instantiated yet — per the Phase 0/1 directive
(Section III), this execution builds architecture only and does not attempt derivations.
...
When a derivation is executed against this layer, it gets its own subfolder here named by its DER-ID,
